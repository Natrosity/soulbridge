...
- **Audible tagging:** rewrites tags and cover art from the Audible listing (via
  ...
  narrator/year, or a dramatised/Graphic Audio version — it's marked **"Alternate edition"** in
  your history (and a dramatised rip keeps its own title) rather than being mislabelled as the one
  you asked for.
